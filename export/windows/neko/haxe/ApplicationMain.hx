...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "Project Space Invaders", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Project Space Invaders";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Project Space Invaders", null, { width: 480, height: 432 });
