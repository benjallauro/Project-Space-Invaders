...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		type.set ("assets/images/Enemigo1.1.png", AssetType.IMAGE);
		path.set ("assets/images/Enemigo1.2.png", "assets/images/Enemigo1.2.png");
		type.set ("assets/images/Enemigo1.2.png", AssetType.IMAGE);
		path.set ("assets/images/Enemigo1.3.png", "assets/images/Enemigo1.3.png");
		type.set ("assets/images/Enemigo1.3.png", AssetType.IMAGE);
		path.set ("assets/images/Enemigo1.4.png", "assets/images/Enemigo1.4.png");
		type.set ("assets/images/Enemigo1.4.png", AssetType.IMAGE);
		...
		id = "assets/images/Enemigo1.1.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/Enemigo1.2.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/Enemigo1.3.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/Enemigo1.4.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
